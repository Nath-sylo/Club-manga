...
=============== The app :
	...
	The 'Random' button will randomly lead you to one of the series (it might lead to an error on some very few occurences : the server looks for a manga with id=0 which does not exist).
